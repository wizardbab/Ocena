<?php 
   ...
   if ($_SESSION['rank'] != 1 || empty($course_info))
         ...
         <div class="h-container" id="top">
            ...
            <form id="msform" method="post" action="/">
               ...
               <h2 class="fs-title">Course Rating</h2>
                  <h3 class="fs-subtitle">Question 1</h3>
                     <input id="c2" class="rating-slider" name="c_q1" data-slider-id='c2Slider' type="text" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="<?php
                                                          ...
                                                          ?>" onchange="changeColor(this.id)">
                  <h3 class="fs-subtitle">Question 2</h3>
                     <input id="c3" class="rating-slider" name="c_q2" data-slider-id='c3Slider' type="text" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="<?php
                                                          ...
                                                          ?>" onchange="changeColor(this.id)">
                  <h3 class="fs-subtitle">Question 3</h3>
                     <input id="c4" class="rating-slider" name="c_q3" data-slider-id='c4Slider' type="text" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="<?php
                                                          ...
                                                          ?>" onchange="changeColor(this.id)">
                  <h3 class="fs-subtitle">Question 4</h3>
                     <input id="c5" class="rating-slider" name="c_q4" data-slider-id='c5Slider' type="text" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="<?php
                                                          ...
                                                          ?>" onchange="changeColor(this.id)">
                  <h3 class="fs-subtitle">Question 5</h3>
                     <input id="c6" class="rating-slider" name="c_q5" data-slider-id='c6Slider' type="text" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="<?php
